...

{
	...
	public void user_should_found_EMail_in_the_Seach_table() {
		...
		boolean status=searchCust.searchCustomerByEmail("victoria_victoria@nopCommerce.com");
	     ...
	     //WebElement mailid=driver.findElement(By.xpath("//*[@id='customers-grid']/tbody/tr[2]/td[2]"));
	     //mailid.getText();
	     //Assert.assertTrue(mailid.equals("Email : victoria_victoria@nopCommerce.com"));
